...
allowed-tools: Bash(node .codegraph/launcher.mjs *), Bash(ls .codegraph/*)
---
...
> ⚠️ CodeGraph no está instalado en este proyecto. Salí de Claude Code y corré:
>
> ```bash
...
> ⚠️ La instalación de CodeGraph en `.codegraph/node_modules/` está corrupta (suele pasar con pnpm en workspaces). Salí de Claude Code y corré:
>
> ```bash
> rm -rf .codegraph
> npx github:sebaarce/phobos
